...
class NewsItemAdapter(activity: AppCompatActivity) :
    BaseRecyclerAdapter<NewsPublisher, NewsItemViewModel, com.news.databinding.NewsItemBinding>(
        activity
    ) {
    override fun onItemBinding(
        binding: com.news.databinding.NewsItemBinding,
